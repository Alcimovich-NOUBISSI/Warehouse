...
namespace Store.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            [Required]
            [StringLength(255, ErrorMessage = "The First Name must be maximum of 255 characters long.")]
            [Display(Name = "First Name")]
            public string FName { get; set; }

            [Required]
            [StringLength(255, ErrorMessage = "The Last Name must be maximum of 255 characters long.")]
